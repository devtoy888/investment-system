...
![Stylized preview of the Previous Conversation recap panel shown when resuming a Hermes session.](https://hermes-agent.nousresearch.com/docs/img/docs/session-recap.svg)
...
#### HTML [​](https://hermes-agent.nousresearch.com/docs/user-guide/sessions\#html "Direct link to HTML")
...
#### Prompts Only [​](https://hermes-agent.nousresearch.com/docs/user-guide/sessions\#prompts-only "Direct link to Prompts Only")
...
#### Traces (HF Agent Trace Viewer) [​](https://hermes-agent.nousresearch.com/docs/user-guide/sessions\#traces-hf-agent-trace-viewer "Direct link to Traces (HF Agent Trace Viewer)")
...
#### Markdown / QMD [​](https://hermes-agent.nousresearch.com/docs/user-guide/sessions\#markdown--qmd "Direct link to Markdown / QMD")
...
### Bulk-Archive Sessions [​](https://hermes-agent.nousresearch.com/docs/user-guide/sessions\#bulk-archive-sessions "Direct link to Bulk-Archive Sessions")
...
- [Session Management Commands](https://hermes-agent.nousresearch.com/docs/user-guide/sessions#session-management-commands)
  ...
  - [Bulk-Archive Sessions](https://hermes-agent.nousresearch.com/docs/user-guide/sessions#bulk-archive-sessions)
