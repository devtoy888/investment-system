...
[**1** Branch](https://github.com/HKUDS/Vibe-Trading/branches) [**8** Tags](https://github.com/HKUDS/Vibe-Trading/tags)
...
| --- | --- | --- | --- |
| ## Latest commit<br>[![warren618](https://avatars.githubusercontent.com/u/127300695?v=4&size=40)](https://github.com/warren618)[warren618](https://github.com/HKUDS/Vibe-Trading/commits?author=warren618)<br>[docs: add 2026-07-21 news across all 5 READMEs](https://github.com/HKUDS/Vibe-Trading/commit/a5eb30fd00d6ee71cd5099d15f57de5ae47010ff)<br>success<br>5 hours agoJul 21, 2026<br>[a5eb30f](https://github.com/HKUDS/Vibe-Trading/commit/a5eb30fd00d6ee71cd5099d15f57de5ae47010ff) · 5 hours agoJul 21, 2026<br>## History<br>[907 Commits](https://github.com/HKUDS/Vibe-Trading/commits/main/) <br>Open commit details<br>[View commit history for this file.](https://github.com/HKUDS/Vibe-Trading/commits/main/) 907 Commits |
| [.devcontainer](https://github.com/HKUDS/Vibe-Trading/tree/main/.devcontainer ".devcontainer") | [.devcontainer](https://github.com/HKUDS/Vibe-Trading/tree/main/.devcontainer ".devcontainer") | [chore: add local dev workflow](https://github.com/HKUDS/Vibe-Trading/commit/d5558eb7610322bf6d82123201db508c8de09e06 "chore: add local dev workflow") | 2 months agoMay 6, 2026 |
| [.github](https://github.com/HKUDS/Vibe-Trading/tree/main/.github ".github") | [.github](https://github.com/HKUDS/Vibe-Trading/tree/main/.github ".github") | [ci: correct setup-node pin comment to v7.0.0 (follow-up](https://github.com/HKUDS/Vibe-Trading/commit/0b2463f10fc7c763a115fb104b2adb834359b10d "ci: correct setup-node pin comment to v7.0.0 (follow-up #720)  Dependabot bumped the setup-node SHA to v7.0.0 (820762786...) but left the pin comment reading # v6. Align the comment with the actual pinned version.") [#720](https://github.com/HKUDS/Vibe-Trading/pull/720) [)](https://github.com/HKUDS/Vibe-Trading/commit/0b2463f10fc7c763a115fb104b2adb834359b10d "ci: correct setup-node pin comment to v7.0.0 (follow-up #720)  Dependabot bumped the setup-node SHA to v7.0.0 (820762786...) but left the pin comment reading # v6. Align the comment with the actual pinned version.") | 2 days agoJul 19, 2026 |
| [agent](https://github.com/HKUDS/Vibe-Trading/tree/main/agent "agent") | [agent](https://github.com/HKUDS/Vibe-Trading/tree/main/agent "agent") | [fix(data): fall back for missing symbols](https://github.com/HKUDS/Vibe-Trading/commit/3b3e82a43b16ed07d44e6c1febf3e909c48b6cdd "fix(data): fall back for missing symbols  Signed-off-by: xkam7ar <kmoteallemi@icloud.com>") | 6 hours agoJul 21, 2026 |
| [assets](https://github.com/HKUDS/Vibe-Trading/tree/main/assets "assets") | [assets](https://github.com/HKUDS/Vibe-Trading/tree/main/assets "assets") | [docs: sync localized READMEs and feature assets](https://github.com/HKUDS/Vibe-Trading/commit/9bfaa4cd37d4b2a367fa3e08307103ca26605303 "docs: sync localized READMEs and feature assets") | 2 months agoMay 13, 2026 |
| [frontend](https://github.com/HKUDS/Vibe-Trading/tree/main/frontend "frontend") | [frontend](https://github.com/HKUDS/Vibe-Trading/tree/main/frontend "frontend") | [Merge pull request](https://github.com/HKUDS/Vibe-Trading/commit/6f996487b3093171d89115721f32bcf78a402def "Merge pull request #731 from octo-patch/octopatch/minimax-cn-endpoint  feat: expose MiniMax regional API endpoints") [#731](https://github.com/HKUDS/Vibe-Trading/pull/731) [from octo-patch/octopatch/minimax-cn-endpoint](https://github.com/HKUDS/Vibe-Trading/commit/6f996487b3093171d89115721f32bcf78a402def "Merge pull request #731 from octo-patch/octopatch/minimax-cn-endpoint  feat: expose MiniMax regional API endpoints") | 7 hours agoJul 21, 2026 |
| [scripts](https://github.com/HKUDS/Vibe-Trading/tree/main/scripts "scripts") | [scripts](https://github.com/HKUDS/Vibe-Trading/tree/main/scripts "scripts") | [fix(ui): streamline composer goal workflow](https://github.com/HKUDS/Vibe-Trading/commit/8e9ec08b18c7b4be9a26f507722d9a9fb17d5206 "fix(ui): streamline composer goal workflow  Move Research Goal entry into the chat composer: the + menu now switches the normal input into goal mode, sends create the session goal directly, and the active goal stays above the input as an inline chip with expandable criteria and evidence details.  Stabilize the local dev launcher used for browser smoke tests by wiring custom backend ports into VITE_API_URL, launching long-lived process groups, cleaning up child processes reliably, and reporting actual frontend/backend status.") | 2 months agoMay 24, 2026 |
| [tools](https://github.com/HKUDS/Vibe-Trading/tree/main/tools "tools") | [tools](https://github.com/HKUDS/Vibe-Trading/tree/main/tools "tools") | [fix: complete env-var migration — CI gate exit 0, 9 schema fields, no…](https://github.com/HKUDS/Vibe-Trading/commit/4c353360d6789ed527f3d4226abd29913d761c72 "fix: complete env-var migration — CI gate exit 0, 9 schema fields, noqa mechanism  - Add 9 missing env vars to EnvConfig schema (QVERIS_API_KEY,   VIBE_TRADING_API_URL, OPENAI_MODEL, FUTU_TRADE_PWD_MD5, etc.) - Migrate 26 os.getenv calls to get_env_config() accessor across 17 files - Add # noqa: env-gate inline suppression to ci_env_var_gate.py (21 lines) - Refactor security.py _env_flag_enabled to direct schema access - Wire CI gate into .github/workflows/test.yml - Fix api_server.py import of deleted constants - Restore _legacy.py timeout positive-value validation - Add reset_env_config() to test_security_auth_api.py for singleton freshness  CI gate: exit 0 (was exit 1 with 54 violations) Tests: 4953 passed, 4 pre-existing tushare failures, 0 regressions  Co-Authored-By: OpenCode <noreply@opencode.ai> AI-Model: qwen3.7-max Co-Authored-By: opencode <noreply@ai-tool.com> Co-Authored-By: Claude Code <noreply@anthropic.com> AI-Contributed/Feature: 188/188 AI-Contributed/UT: 39/39") | 2 weeks agoJul 8, 2026 |
| [wiki](https://github.com/HKUDS/Vibe-Trading/tree/main/wiki "wiki") | [wiki](https://github.com/HKUDS/Vibe-Trading/tree/main/wiki "wiki") | [fix(docs): propagate the fundamental zoo family + 0.1.11 counts to fr…](https://github.com/HKUDS/Vibe-Trading/commit/d456025672ae6cff1851ba2e77ca1a8f9abdcb47 "fix(docs): propagate the fundamental zoo family + 0.1.11 counts to frontend, skills, and wiki  Post-release cross-audit findings: the 5th Alpha Zoo family never reached the frontend (AlphaZoo card grid missing fundamental, academic still 6, '4 zoos' i18n strings x5 locales), factors/__init__ docstring, or the asset-allocation skill ('4 optimizers'). Wiki: 29->30 presets, docs version selector bumped to 0.1.11 (labels only; content is unversioned). README x5: locale parity for the 07-04 UTC news entry, india_broker in the loaders tree comment (20 sources), ja/ko contributor headings translated.") | 2 weeks agoJul 10, 2026 |
| [.dockerignore](https://github.com/HKUDS/Vibe-Trading/blob/main/.dockerignore ".dockerignore") | [.dockerignore](https://github.com/HKUDS/Vibe-Trading/blob/main/.dockerignore ".dockerignore") | [chore(release): 0.1.10 — version sync + wheel packaging + Docker weas…](https://github.com/HKUDS/Vibe-Trading/commit/54f944743efee7b9cbaaeafb5966c583d0d4ac66 "chore(release): 0.1.10 — version sync + wheel packaging + Docker weasyprint libs (#271)  * chore(release): 0.1.10 — version sync, wheel packaging, Docker weasyprint libs  Release-prep for 0.1.10 (bundles the global data layer + everything since 0.1.9):  - version 0.1.9 -> 0.1.10 synced across all surfaces: pyproject, frontend   package.json/lock, sidebar footer + i18n, SKILL.md, Dockerfile LABEL. REST   API + MCP server now derive the version from cli._version (were hardcoded   \"5.0.0\" / unset). - pyproject package-data ships skill example scripts (skills/**/*.py) so the   wheel + sdist include them; fastmcp floor -> 2.14.0 (first release where the   MCP version= kwarg applies). - Dockerfile installs weasyprint native libs (Pango/HarfBuzz/Fontconfig/Cairo/   gdk-pixbuf + DejaVu) so PDF reports render in the image; .dockerignore *.md   -> /*.md (root-anchored, skill markdown still ships). - README news (5 locales): 06-19 reframed as the v0.1.10 release; 06-19/06-18   trimmed.  Verified: clean-room pip install imports all new loaders/tools; wheel + sdist carry the eastmoney/sec-edgar skills incl. UTF-8 references + scripts; 4167 backend tests pass (weasyprint PDF path covered on CI).  * docs(release): credit v0.1.10 cycle contributors across READMEs  Refresh the Contributors section in all 5 READMEs from the v0.1.9 cycle to the v0.1.10 cycle (PRs #162–#260): @Hinotoi-agent, @mvanhorn, @gyx09212214-prog, @BillDin, @Robin1987China, @LemonCANDY42, @zwrong, @forge-builder, @skloxo, @LeeCQiang, @KaiLuettmann, @ngoanpv, @ShahNewazKhan, @sambazhu, @bhlt, @octo-patch.") | last monthJun 19, 2026 |
| [.gitignore](https://github.com/HKUDS/Vibe-Trading/blob/main/.gitignore ".gitignore") | [.gitignore](https://github.com/HKUDS/Vibe-Trading/blob/main/.gitignore ".gitignore") | [test: add frontend test suite + backend security/coverage tests](https://github.com/HKUDS/Vibe-Trading/commit/16e22b97253de1ed9e453c830e96f14094d4876b "test: add frontend test suite + backend security/coverage tests  Cherry-picked the test-infra commit from #175 (sambazhu): vitest setup + 19 frontend test files (197 tests), backend auth/path-traversal/CORS tests, yfinance crypto fallback (BTC-USDT->BTC-USD), and CI coverage + frontend-test steps. Dropped the PR's separate i18n commit to stay consistent with #163.  Fix: align @vitest/coverage-v8 to ^3.2.6 (was ^4.1.8, incompatible with vitest ^3.2.6 - blocked npm install and the new npm ci CI step).") | last monthJun 5, 2026 |
| [AGENT\_CONTRIBUTOR\_GUIDE.md](https://github.com/HKUDS/Vibe-Trading/blob/main/AGENT_CONTRIBUTOR_GUIDE.md "AGENT_CONTRIBUTOR_GUIDE.md") | [AGENT\_CONTRIBUTOR\_GUIDE.md](https://github.com/HKUDS/Vibe-Trading/blob/main/AGENT_CONTRIBUTOR_GUIDE.md "AGENT_CONTRIBUTOR_GUIDE.md") | [revert: back out IRR-AGL reliability/governance stack (](https://github.com/HKUDS/Vibe-Trading/commit/310183b0af3bd9d9a6653672a714524df02752f4 "revert: back out IRR-AGL reliability/governance stack (#405, #416)  Reverts merge commits a2f8062 (#405) and af893c1 (#416), and removes the now-orphaned #406 artifact metadata store (src/reliability + tests, zero references left outside its own tests).  Why: the stack wrapped the tool registry in every session path (even governance mode=off) without exposing the registry surface AgentContext reads, breaking all session-runtime chats within a day (#433, #431). It also modified protected core files (src/agent/loop.py, src/session/ service.py), shipped 12 internal-convention docs/ files into the public tree, and its enforcement layer already has reported bypass paths (#420). Trading safety stays on the single mandate-gate design (#31, #144).  README news entries for 2026-07-07/07-06 updated accordingly.") [#405](https://github.com/HKUDS/Vibe-Trading/pull/405) [,](https://github.com/HKUDS/Vibe-Trading/commit/310183b0af3bd9d9a6653672a714524df02752f4 "revert: back out IRR-AGL reliability/governance stack (#405, #416)  Reverts merge commits a2f8062 (#405) and af893c1 (#416), and removes the now-orphaned #406 artifact metadata store (src/reliability + tests, zero references left outside its own tests).  Why: the stack wrapped the tool registry in every session path (even governance mode=off) without exposing the registry surface AgentContext reads, breaking all session-runtime chats within a day (#433, #431). It also modified protected core files (src/agent/loop.py, src/session/ service.py), shipped 12 internal-convention docs/ files into the public tree, and its enforcement layer already has reported bypass paths (#420). Trading safety stays on the single mandate-gate design (#31, #144).  README news entries for 2026-07-07/07-06 updated accordingly.") [#416](https://github.com/HKUDS/Vibe-Trading/pull/416) [)](https://github.com/HKUDS/Vibe-Trading/commit/310183b0af3bd9d9a6653672a714524df02752f4 "revert: back out IRR-AGL reliability/governance stack (#405, #416)  Reverts merge commits a2f8062 (#405) and af893c1 (#416), and removes the now-orphaned #406 artifact metadata store (src/reliability + tests, zero references left outside its own tests).  Why: the stack wrapped the tool registry in every session path (even governance mode=off) without exposing the registry surface AgentContext reads, breaking all session-runtime chats within a day (#433, #431). It also modified protected core files (src/agent/loop.py, src/session/ service.py), shipped 12 internal-convention docs/ files into the public tree, and its enforcement layer already has reported bypass paths (#420). Trading safety stays on the single mandate-gate design (#31, #144).  README news entries for 2026-07-07/07-06 updated accordingly.") | 2 weeks agoJul 8, 2026 |
| [CHANGELOG.md](https://github.com/HKUDS/Vibe-Trading/blob/main/CHANGELOG.md "CHANGELOG.md") | [CHANGELOG.md](https://github.com/HKUDS/Vibe-Trading/blob/main/CHANGELOG.md "CHANGELOG.md") | [Merge PR](https://github.com/HKUDS/Vibe-Trading/commit/590c304b8a862352911cb0e7b90a51926a75cc49 "Merge PR #481: feat: MetaTrader 5 (Exness) broker connector + mt5 market-data source  Red-lines verified PASS (mandate gate, structural trade_mode discriminator, no MCP order exposure, sandbox-barred loader). Resolved additive conflicts: registry (mt5 loader alongside longbridge), pyproject (mt5 extra), CHANGELOG (kept both entries); README/SKILL counts reconciled in the news pass. market_data =F/=X (yahoo) and mt5 forex routing coexist.") [#481](https://github.com/HKUDS/Vibe-Trading/pull/481) [: feat: MetaTrader 5 (Exness) broker connector + mt5 mar…](https://github.com/HKUDS/Vibe-Trading/commit/590c304b8a862352911cb0e7b90a51926a75cc49 "Merge PR #481: feat: MetaTrader 5 (Exness) broker connector + mt5 market-data source  Red-lines verified PASS (mandate gate, structural trade_mode discriminator, no MCP order exposure, sandbox-barred loader). Resolved additive conflicts: registry (mt5 loader alongside longbridge), pyproject (mt5 extra), CHANGELOG (kept both entries); README/SKILL counts reconciled in the news pass. market_data =F/=X (yahoo) and mt5 forex routing coexist.") | yesterdayJul 20, 2026 |
| [CODE\_OF\_CONDUCT.md](https://github.com/HKUDS/Vibe-Trading/blob/main/CODE_OF_CONDUCT.md "CODE_OF_CONDUCT.md") | [CODE\_OF\_CONDUCT.md](https://github.com/HKUDS/Vibe-Trading/blob/main/CODE_OF_CONDUCT.md "CODE_OF_CONDUCT.md") | [docs: add CODE\_OF\_CONDUCT and SECURITY policy](https://github.com/HKUDS/Vibe-Trading/commit/668a6105c2d9a13f823305d175779bfd60e32986 "docs: add CODE_OF_CONDUCT and SECURITY policy  Add Contributor Covenant v2.1 and security vulnerability reporting guide to improve GitHub Community Health score.") | 3 months agoApr 13, 2026 |
| [CONTRIBUTING.md](https://github.com/HKUDS/Vibe-Trading/blob/main/CONTRIBUTING.md "CONTRIBUTING.md") | [CONTRIBUTING.md](https://github.com/HKUDS/Vibe-Trading/blob/main/CONTRIBUTING.md "CONTRIBUTING.md") | [build: install Black and Ruff for contributors](https://github.com/HKUDS/Vibe-Trading/commit/2bf04c98a1ecb18c800e18f35a959b2dd3946f48 "build: install Black and Ruff for contributors  Signed-off-by: xkam7ar <kmoteallemi@icloud.com>") | 5 days agoJul 16, 2026 |
| [Dockerfile](https://github.com/HKUDS/Vibe-Trading/blob/main/Dockerfile "Dockerfile") | [Dockerfile](https://github.com/HKUDS/Vibe-Trading/blob/main/Dockerfile "Dockerfile") | [security: address all 10 findings from external audit (issue](https://github.com/HKUDS/Vibe-Trading/commit/a68c6852d843ded0118f0a289dcbe3e8eebd7a39 "security: address all 10 findings from external audit (issue #476)  Implements VT-001 through VT-010 from the 2026-07-10 external security audit (Trivy/Semgrep/ZAP/Gitleaks/pip-audit against a real deployment):  - VT-001 (Critical): AST hardening in backtest/runner.py rejects   network/subprocess/eval/os.environ/unsafe-open calls reachable from   generated SignalEngine method bodies (previously only checked   top-level statements). Defense-in-depth: ephemeral per-run HOME,   RLIMIT_AS/NOFILE caps, best-effort UID-drop to a new vibe-sandbox   user (currently inert under Docker's cap model - see session doc;   accepted as documented residual gap, primary AST defense unaffected). - VT-002: multi-stage Dockerfile split so build-essential never   reaches the runtime image. - VT-003: SSE auth moved from a long-lived API key in the URL query   string to short-lived single-use tickets; access-log redaction for   any remaining query secrets. - VT-004: agent/.env split-brain fixed (bind mount + atomic 0600   writes) between docker-compose and Web UI settings writes. - VT-005: /correlation now requires auth + per-IP rate limit; generic   exceptions no longer leak raw text to clients. - VT-006: CSP-Report-Only + security headers middleware; Google Fonts   replaced with self-hosted @fontsource packages. - VT-007: docker-compose hardening (cap_drop ALL + minimal cap_add,   no-new-privileges, read_only rootfs, resource limits). - VT-008: /health split into /live (liveness) and /ready (real   provider-config readiness check); /health kept as a compat alias. - VT-009: base images pinned by digest, GitHub Actions pinned by   commit SHA, dependabot.yml added, hash-verified requirements-lock.txt   now actually wired into the Docker build via --require-hashes. - VT-010: universe-panel pickle cache sidecar upgraded from an   unkeyed SHA-256 (forgeable by anyone with cache-dir write access)   to a keyed HMAC.  Implemented via a 5-parcel Workflow (file-disjoint, independent adversarial verification per parcel, then a holistic final audit). The final audit caught a real regression (CI env-var-gate violation) and confirmed a dependency-pinning gap, both fixed and re-verified here, including a latent transitive-dependency bug the fix surfaced (smartmoneyconcepts<0.0.27 pulls an unbuildable zigzag package) - see docs/sessions/2026-07-13_session_vt476_security_hardening.md (local, gitignored) for full evidence trail.  Full suite: 5191 passed, 6 pre-existing/environmental failures (unchanged from main). Docker build + hardened compose boot verified end-to-end.") [#476](https://github.com/HKUDS/Vibe-Trading/issues/476) [)](https://github.com/HKUDS/Vibe-Trading/commit/a68c6852d843ded0118f0a289dcbe3e8eebd7a39 "security: address all 10 findings from external audit (issue #476)  Implements VT-001 through VT-010 from the 2026-07-10 external security audit (Trivy/Semgrep/ZAP/Gitleaks/pip-audit against a real deployment):  - VT-001 (Critical): AST hardening in backtest/runner.py rejects   network/subprocess/eval/os.environ/unsafe-open calls reachable from   generated SignalEngine method bodies (previously only checked   top-level statements). Defense-in-depth: ephemeral per-run HOME,   RLIMIT_AS/NOFILE caps, best-effort UID-drop to a new vibe-sandbox   user (currently inert under Docker's cap model - see session doc;   accepted as documented residual gap, primary AST defense unaffected). - VT-002: multi-stage Dockerfile split so build-essential never   reaches the runtime image. - VT-003: SSE auth moved from a long-lived API key in the URL query   string to short-lived single-use tickets; access-log redaction for   any remaining query secrets. - VT-004: agent/.env split-brain fixed (bind mount + atomic 0600   writes) between docker-compose and Web UI settings writes. - VT-005: /correlation now requires auth + per-IP rate limit; generic   exceptions no longer leak raw text to clients. - VT-006: CSP-Report-Only + security headers middleware; Google Fonts   replaced with self-hosted @fontsource packages. - VT-007: docker-compose hardening (cap_drop ALL + minimal cap_add,   no-new-privileges, read_only rootfs, resource limits). - VT-008: /health split into /live (liveness) and /ready (real   provider-config readiness check); /health kept as a compat alias. - VT-009: base images pinned by digest, GitHub Actions pinned by   commit SHA, dependabot.yml added, hash-verified requirements-lock.txt   now actually wired into the Docker build via --require-hashes. - VT-010: universe-panel pickle cache sidecar upgraded from an   unkeyed SHA-256 (forgeable by anyone with cache-dir write access)   to a keyed HMAC.  Implemented via a 5-parcel Workflow (file-disjoint, independent adversarial verification per parcel, then a holistic final audit). The final audit caught a real regression (CI env-var-gate violation) and confirmed a dependency-pinning gap, both fixed and re-verified here, including a latent transitive-dependency bug the fix surfaced (smartmoneyconcepts<0.0.27 pulls an unbuildable zigzag package) - see docs/sessions/2026-07-13_session_vt476_security_hardening.md (local, gitignored) for full evidence trail.  Full suite: 5191 passed, 6 pre-existing/environmental failures (unchanged from main). Docker build + hardened compose boot verified end-to-end.") | last weekJul 12, 2026 |
| [LICENSE](https://github.com/HKUDS/Vibe-Trading/blob/main/LICENSE "LICENSE") | [LICENSE](https://github.com/HKUDS/Vibe-Trading/blob/main/LICENSE "LICENSE") | [Initial commit](https://github.com/HKUDS/Vibe-Trading/commit/34eae37ba4510220cbc38223166d19cc148ea6f6 "Initial commit") | 4 months agoApr 1, 2026 |
| [MANIFEST.in](https://github.com/HKUDS/Vibe-Trading/blob/main/MANIFEST.in "MANIFEST.in") | [MANIFEST.in](https://github.com/HKUDS/Vibe-Trading/blob/main/MANIFEST.in "MANIFEST.in") | [chore(0.1.8): version, CHANGELOG, packaging, News across 5 READMEs, S…](https://github.com/HKUDS/Vibe-Trading/commit/78bc1e50d76dba83521d754877e7862ac8606e57 "chore(0.1.8): version, CHANGELOG, packaging, News across 5 READMEs, SKILL.md  Release prep for Alpha Zoo v1. Wraps up the 0.1.8 main-branch content so PyPI + ClawHub publish can run from a clean checkout.  Version - pyproject.toml: 0.1.7 → 0.1.8 - wiki/docs/content.js: DOCS_DEFAULT_VERSION 0.1.7 → 0.1.8 + 0.1.7   retained in the version dropdown - agent/SKILL.md frontmatter: 0.1.7 → 0.1.8  Packaging - pyproject.toml [tool.setuptools.package-data] adds the new   src.factors zoo asset globs (zoo/**/*.yaml, zoo/**/*.md,   zoo/**/NOTICE) alongside the existing src and backtest entries - MANIFEST.in adds `recursive-include agent/src/factors *.yaml *.md`   and `include NOTICE`  CHANGELOG.md (first changelog file in the repo) - Full 0.1.8 entry covering the Alpha Zoo (4 zoos × 452 alphas),   Web UI + 4 REST routes, CLI subcommand suite, safety floor   (AST purity gate + lookahead test + pytest-socket + grep gates),   community governance (CONTRIBUTING + DCO + NOTICE + per-zoo   LICENSE.md), and the IC/IR core extraction. - Known limitations subsection: btc-usdt is single-asset; cross-   sectional IC needs ≥2 instruments; crypto-majors basket planned   for 0.2. - [Unreleased] anchor at top for the next cycle.  agent/SKILL.md (ClawHub package descriptor) - Frontmatter description gains Alpha Zoo + 75 skills (was 74) - New `### Alpha Zoo (452 pre-built alphas)` section with the   4-zoo breakdown + CLI / REST / signal-engine entry points - Skill count 74 → 75 wherever it appears - Trademarked-name string intentionally absent (CI gate b enforces)  5 READMEs (EN/ZH/JA/KO/AR) per `docs/alpha-zoo/readme-update-spec.md` - Roadmap: Alpha Zoo `Planned` → `Shipped 0.1.8` with expanded   description (452 alphas, 4 zoo sources, CLI + agent + Web UI) - Skill count 74 → 75 (Tool category 10 → 11, `alpha-zoo` added) - Agent tools count 29 → 31 (alpha_zoo_tool, alpha_bench_tool) - Project structure tree: new `factors/` block (base / registry /   bench_runner / zoo), new `api/` block (alpha_routes), new   top-level `tools/` block (ci_grep_gates.sh). Frontend pages list   expanded (AlphaZoo, Correlation, Settings) - Quick Example: second snippet showing `alpha bench` one-liner - New \"What You Can Do\" row for the bench-a-pre-built-alpha-zoo path - New `<details>` block under Detailed Capabilities listing the   4 zoos + counts + sources + license stance - Examples → Strategy & Backtesting: 3 snippets (bench, list+show,   multi-factor compose via ZooSignalEngine.from_zoo) - API Server route table: 4 `/alpha/*` rows (list, get, bench,   bench stream SSE) - CLI Reference: alpha subcommand introduced in the top block;   single-run examples block extended with 3 alpha commands  `### Key Features` 4-card grid (#7) and Demo section (#13) are intentionally NOT touched here — they need layout redesign + new GIFs/screenshots; design notes in docs/alpha-zoo/readme-redesign-7-13.md will be implemented in a follow-up PR.  969 tests pass; CI grep gates green (no yaml.load misuse, no trademarked-name leak, no per-stock-code data in wiki); TypeScript clean on the frontend.") | 2 months agoMay 17, 2026 |
| [NOTICE](https://github.com/HKUDS/Vibe-Trading/blob/main/NOTICE "NOTICE") | [NOTICE](https://github.com/HKUDS/Vibe-Trading/blob/main/NOTICE "NOTICE") | [feat(factors): Alpha Zoo framework — registry, operators, safety gates](https://github.com/HKUDS/Vibe-Trading/commit/7d678aabda18c9e3094e0973763e9c1360817599 "feat(factors): Alpha Zoo framework — registry, operators, safety gates  New module agent/src/factors/ providing the foundation for the Alpha Zoo:  - base.py: 19 cross-sectional + time-series operators on wide   pd.DataFrame panels (rank/scale/ts_*/delta/decay_linear/signed_power/   safe_div + market-aware vwap). NaN propagates strictly; delta(d>=1)   enforced at the operator layer; no negative shifts allowed. - registry.py: AST-extracts __alpha_meta__ from each zoo .py module   without importing it; pydantic AlphaMeta (extra=\"forbid\",   frozen=True). Lazy importlib.import_module on compute(); filesystem-   loader fallback for plugin/test trees. Sanity gates reject +/-inf,   NaN ratio > 95%, and shape mismatches. - factor_analysis_core.py: IC/IR + layered backtest math extracted   from agent/src/tools/factor_analysis_tool.py so it's reusable from   CLI, bench tool, and API. - bench_runner.py: per-alpha compute → IC vs forward return →   alive/reversed/dead categorisation (mean IC > 0.02, pos_ratio >=   0.55, |t-stat| > 2). Shared by CLI driver and API worker.  Multi-factor skill gains a panel-style ZooSignalEngine.from_zoo() factory (cross-sectional standardisation + weighting + optional top-N / bottom-N long-short conversion). The legacy per-symbol example_signal_engine.py is left untouched. SKILL.md edits in multi-factor and factor-research cross-reference the new zoo.  Safety floor: - test_alpha_purity.py: AST allowlist scan of every zoo/**/*.py   module. Allowed imports: pandas, numpy, scipy.*, src.factors.base,   __future__, typing, math, dataclasses. Banned names: os/sys/   subprocess/socket/urllib/requests/httpx/pathlib/Path/open/eval/exec/   compile/__import__, plus dunder-access via getattr(_, \"__*\"),   breakpoint, input, help, memoryview, globals, locals, vars, and   the __class__/__bases__/__mro__/__globals__/__builtins__ chain.   Module-level statements limited to docstring + imports + functions   + ALPHA_ID/__alpha_meta__ assignments with literal RHS. - test_lookahead.py: 300-row synthetic panel; corrupt rows >= 270;   assert factor at probe row 260 unchanged within 1e-9. - test_base.py + test_registry.py + conftest.py with opt-in   pytest-socket integration that hard-fails outbound network during   the factors test suite. - tools/ci_grep_gates.sh: rejects yaml.load( without safe_load,   any trademarked-name leak in shipped artifacts, and any per-stock-   code data leak in wiki/**/*.{json,csv,html}.  Governance: - CONTRIBUTING.md with the Developer Certificate of Origin trailer   for community PRs and the alpha PR reviewer checklist. - NOTICE at the repo root with Apache-2.0 attribution for the   upstream qlib NOTICE and the formulas-as-mathematical-content   stance for Kakushadze / GTJA / Fama-French sources.") | 2 months agoMay 17, 2026 |
| [README.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README.md "README.md") | [README.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README.md "README.md") | [docs: add 2026-07-21 news across all 5 READMEs](https://github.com/HKUDS/Vibe-Trading/commit/a5eb30fd00d6ee71cd5099d15f57de5ae47010ff "docs: add 2026-07-21 news across all 5 READMEs") | 5 hours agoJul 21, 2026 |
| [README\_ar.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_ar.md "README_ar.md") | [README\_ar.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_ar.md "README_ar.md") | [docs: add 2026-07-21 news across all 5 READMEs](https://github.com/HKUDS/Vibe-Trading/commit/a5eb30fd00d6ee71cd5099d15f57de5ae47010ff "docs: add 2026-07-21 news across all 5 READMEs") | 5 hours agoJul 21, 2026 |
| [README\_ja.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_ja.md "README_ja.md") | [README\_ja.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_ja.md "README_ja.md") | [docs: add 2026-07-21 news across all 5 READMEs](https://github.com/HKUDS/Vibe-Trading/commit/a5eb30fd00d6ee71cd5099d15f57de5ae47010ff "docs: add 2026-07-21 news across all 5 READMEs") | 5 hours agoJul 21, 2026 |
| [README\_ko.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_ko.md "README_ko.md") | [README\_ko.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_ko.md "README_ko.md") | [docs: add 2026-07-21 news across all 5 READMEs](https://github.com/HKUDS/Vibe-Trading/commit/a5eb30fd00d6ee71cd5099d15f57de5ae47010ff "docs: add 2026-07-21 news across all 5 READMEs") | 5 hours agoJul 21, 2026 |
| [README\_zh.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_zh.md "README_zh.md") | [README\_zh.md](https://github.com/HKUDS/Vibe-Trading/blob/main/README_zh.md "README_zh.md") | [docs: add 2026-07-21 news across all 5 READMEs](https://github.com/HKUDS/Vibe-Trading/commit/a5eb30fd00d6ee71cd5099d15f57de5ae47010ff "docs: add 2026-07-21 news across all 5 READMEs") | 5 hours agoJul 21, 2026 |
| [SECURITY.md](https://github.com/HKUDS/Vibe-Trading/blob/main/SECURITY.md "SECURITY.md") | [SECURITY.md](https://github.com/HKUDS/Vibe-Trading/blob/main/SECURITY.md "SECURITY.md") | [fix(core): narrow backtest subprocess environment](https://github.com/HKUDS/Vibe-Trading/commit/38de446c4c015ad2966411b41c9e18952709b2d1 "fix(core): narrow backtest subprocess environment  Closes #332  Summary: - Narrow generated-backtest subprocess environment inheritance to OS/Python basics, proxy/certificate settings, allowed run-root config, and read-only market-data settings. - Avoid forwarding LLM provider keys, API auth tokens, shell-tool switches, broker trading secrets, and live/advisory toggles into generated strategy code. - Document the generated backtest trust boundary in README and SECURITY.  Validation: - PYTHONPATH=agent pytest agent/tests/test_runner_env.py agent/tests/test_run_card.py agent/tests/test_path_safety.py agent/tests/test_file_tool_sandbox_security.py -q - python -m ruff check agent/src/core/runner.py agent/tests/test_runner_env.py - python -m compileall -q agent/src/core/runner.py agent/tests/test_runner_env.py - git diff --check - GitHub Actions CI passed") | 3 weeks agoJul 2, 2026 |
| [docker-compose.yml](https://github.com/HKUDS/Vibe-Trading/blob/main/docker-compose.yml "docker-compose.yml") | [docker-compose.yml](https://github.com/HKUDS/Vibe-Trading/blob/main/docker-compose.yml "docker-compose.yml") | [security: address all 10 findings from external audit (issue](https://github.com/HKUDS/Vibe-Trading/commit/a68c6852d843ded0118f0a289dcbe3e8eebd7a39 "security: address all 10 findings from external audit (issue #476)  Implements VT-001 through VT-010 from the 2026-07-10 external security audit (Trivy/Semgrep/ZAP/Gitleaks/pip-audit against a real deployment):  - VT-001 (Critical): AST hardening in backtest/runner.py rejects   network/subprocess/eval/os.environ/unsafe-open calls reachable from   generated SignalEngine method bodies (previously only checked   top-level statements). Defense-in-depth: ephemeral per-run HOME,   RLIMIT_AS/NOFILE caps, best-effort UID-drop to a new vibe-sandbox   user (currently inert under Docker's cap model - see session doc;   accepted as documented residual gap, primary AST defense unaffected). - VT-002: multi-stage Dockerfile split so build-essential never   reaches the runtime image. - VT-003: SSE auth moved from a long-lived API key in the URL query   string to short-lived single-use tickets; access-log redaction for   any remaining query secrets. - VT-004: agent/.env split-brain fixed (bind mount + atomic 0600   writes) between docker-compose and Web UI settings writes. - VT-005: /correlation now requires auth + per-IP rate limit; generic   exceptions no longer leak raw text to clients. - VT-006: CSP-Report-Only + security headers middleware; Google Fonts   replaced with self-hosted @fontsource packages. - VT-007: docker-compose hardening (cap_drop ALL + minimal cap_add,   no-new-privileges, read_only rootfs, resource limits). - VT-008: /health split into /live (liveness) and /ready (real   provider-config readiness check); /health kept as a compat alias. - VT-009: base images pinned by digest, GitHub Actions pinned by   commit SHA, dependabot.yml added, hash-verified requirements-lock.txt   now actually wired into the Docker build via --require-hashes. - VT-010: universe-panel pickle cache sidecar upgraded from an   unkeyed SHA-256 (forgeable by anyone with cache-dir write access)   to a keyed HMAC.  Implemented via a 5-parcel Workflow (file-disjoint, independent adversarial verification per parcel, then a holistic final audit). The final audit caught a real regression (CI env-var-gate violation) and confirmed a dependency-pinning gap, both fixed and re-verified here, including a latent transitive-dependency bug the fix surfaced (smartmoneyconcepts<0.0.27 pulls an unbuildable zigzag package) - see docs/sessions/2026-07-13_session_vt476_security_hardening.md (local, gitignored) for full evidence trail.  Full suite: 5191 passed, 6 pre-existing/environmental failures (unchanged from main). Docker build + hardened compose boot verified end-to-end.") [#476](https://github.com/HKUDS/Vibe-Trading/issues/476) [)](https://github.com/HKUDS/Vibe-Trading/commit/a68c6852d843ded0118f0a289dcbe3e8eebd7a39 "security: address all 10 findings from external audit (issue #476)  Implements VT-001 through VT-010 from the 2026-07-10 external security audit (Trivy/Semgrep/ZAP/Gitleaks/pip-audit against a real deployment):  - VT-001 (Critical): AST hardening in backtest/runner.py rejects   network/subprocess/eval/os.environ/unsafe-open calls reachable from   generated SignalEngine method bodies (previously only checked   top-level statements). Defense-in-depth: ephemeral per-run HOME,   RLIMIT_AS/NOFILE caps, best-effort UID-drop to a new vibe-sandbox   user (currently inert under Docker's cap model - see session doc;   accepted as documented residual gap, primary AST defense unaffected). - VT-002: multi-stage Dockerfile split so build-essential never   reaches the runtime image. - VT-003: SSE auth moved from a long-lived API key in the URL query   string to short-lived single-use tickets; access-log redaction for   any remaining query secrets. - VT-004: agent/.env split-brain fixed (bind mount + atomic 0600   writes) between docker-compose and Web UI settings writes. - VT-005: /correlation now requires auth + per-IP rate limit; generic   exceptions no longer leak raw text to clients. - VT-006: CSP-Report-Only + security headers middleware; Google Fonts   replaced with self-hosted @fontsource packages. - VT-007: docker-compose hardening (cap_drop ALL + minimal cap_add,   no-new-privileges, read_only rootfs, resource limits). - VT-008: /health split into /live (liveness) and /ready (real   provider-config readiness check); /health kept as a compat alias. - VT-009: base images pinned by digest, GitHub Actions pinned by   commit SHA, dependabot.yml added, hash-verified requirements-lock.txt   now actually wired into the Docker build via --require-hashes. - VT-010: universe-panel pickle cache sidecar upgraded from an   unkeyed SHA-256 (forgeable by anyone with cache-dir write access)   to a keyed HMAC.  Implemented via a 5-parcel Workflow (file-disjoint, independent adversarial verification per parcel, then a holistic final audit). The final audit caught a real regression (CI env-var-gate violation) and confirmed a dependency-pinning gap, both fixed and re-verified here, including a latent transitive-dependency bug the fix surfaced (smartmoneyconcepts<0.0.27 pulls an unbuildable zigzag package) - see docs/sessions/2026-07-13_session_vt476_security_hardening.md (local, gitignored) for full evidence trail.  Full suite: 5191 passed, 6 pre-existing/environmental failures (unchanged from main). Docker build + hardened compose boot verified end-to-end.") | last weekJul 12, 2026 |
| [pyproject.toml](https://github.com/HKUDS/Vibe-Trading/blob/main/pyproject.toml "pyproject.toml") | [pyproject.toml](https://github.com/HKUDS/Vibe-Trading/blob/main/pyproject.toml "pyproject.toml") | [Merge PR](https://github.com/HKUDS/Vibe-Trading/commit/ff8b27716a520a4a27d11cbb8d62fa9eefe0c13b "Merge PR #695: feat(providers): add native Anthropic Messages API support  Self-fix on merge: moved langchain-anthropic from core dependencies to an [anthropic] optional extra (like [deepseek]) — _build_anthropic lazy-imports it and raises an actionable install hint, so the base install stays lean. Resolved llm.py conflicts against #563's centralized get_llm_credentials + the anthropic native adapter-mode branch. Closes #694.") [#695](https://github.com/HKUDS/Vibe-Trading/pull/695) [: feat(providers): add native Anthropic Messages API sup…](https://github.com/HKUDS/Vibe-Trading/commit/ff8b27716a520a4a27d11cbb8d62fa9eefe0c13b "Merge PR #695: feat(providers): add native Anthropic Messages API support  Self-fix on merge: moved langchain-anthropic from core dependencies to an [anthropic] optional extra (like [deepseek]) — _build_anthropic lazy-imports it and raises an actionable install hint, so the base install stays lean. Resolved llm.py conflicts against #563's centralized get_llm_credentials + the anthropic native adapter-mode branch. Closes #694.") | yesterdayJul 20, 2026 |
| [requirements-lock.txt](https://github.com/HKUDS/Vibe-Trading/blob/main/requirements-lock.txt "requirements-lock.txt") | [requirements-lock.txt](https://github.com/HKUDS/Vibe-Trading/blob/main/requirements-lock.txt "requirements-lock.txt") | [Merge pull request](https://github.com/HKUDS/Vibe-Trading/commit/73b53bd210539f85b8141ea550c1fe8035e0aa6d "Merge pull request #725 from HKUDS/dependabot/pip/websockets-16.1.1  build(deps): bump websockets from 15.0.1 to 16.1.1") [#725](https://github.com/HKUDS/Vibe-Trading/pull/725) [from HKUDS/dependabot/pip/websockets-16.1.1](https://github.com/HKUDS/Vibe-Trading/commit/73b53bd210539f85b8141ea550c1fe8035e0aa6d "Merge pull request #725 from HKUDS/dependabot/pip/websockets-16.1.1  build(deps): bump websockets from 15.0.1 to 16.1.1") | 7 hours agoJul 21, 2026 |
| View all files |
...
[![HKUDS%2FVibe-Trading | Trendshift](https://camo.githubusercontent.com/ff13be6d533cac21bc83ad7de53b2de0b2358a6517de3b771ede5993b4f4ba17/68747470733a2f2f7472656e6473686966742e696f2f6170692f62616467652f7265706f7369746f726965732f3235353237)](https://trendshift.io/repositories/25527)
...
|     |     |
| --- | --- |
| [![Self-improving trading agent](https://github.com/HKUDS/Vibe-Trading/raw/main/assets/feature-self-improving-trading-agent.png)](https://github.com/HKUDS/Vibe-Trading/blob/main/assets/feature-self-improving-trading-agent.png)<br>### 🔍 Self-Improving Trading Agent<br>[Permalink: 🔍 Self-Improving Trading Agent](https://github.com/HKUDS/Vibe-Trading#-self-improving-trading-agent)<br>• Natural-language market research<br>• Strategy drafts and file/web analysis<br>• Memory-backed workflows | [![Multi-agent trading teams](https://github.com/HKUDS/Vibe-Trading/raw/main/assets/feature-multi-agent-trading-teams.png)](https://github.com/HKUDS/Vibe-Trading/blob/main/assets/feature-multi-agent-trading-teams.png)<br>### 🐝 Multi-Agent Trading Teams<br>[Permalink: 🐝 Multi-Agent Trading Teams](https://github.com/HKUDS/Vibe-Trading#-multi-agent-trading-teams)<br>• Investment, quant, crypto, and risk teams<br>• Streaming progress and persisted reports<br>• Workers grounded with fetched market data |
| [![Cross-market data and backtesting](https://github.com/HKUDS/Vibe-Trading/raw/main/assets/feature-cross-market-data-backtesting.png)](https://github.com/HKUDS/Vibe-Trading/blob/main/assets/feature-cross-market-data-backtesting.png)<br>### 📊 Cross-Market Data & Backtesting<br>[Permalink: 📊 Cross-Market Data & Backtesting](https://github.com/HKUDS/Vibe-Trading#-cross-market-data--backtesting)<br>• A/HK/US equities, crypto, futures, and forex<br>• Data fallback and composite backtests<br>• PIT data, validation, and run cards | [![Shadow Account](https://github.com/HKUDS/Vibe-Trading/raw/main/assets/feature-shadow-account.png)](https://github.com/HKUDS/Vibe-Trading/blob/main/assets/feature-shadow-account.png)<br>### 👥 Shadow Account<br>[Permalink: 👥 Shadow Account](https://github.com/HKUDS/Vibe-Trading#-shadow-account)<br>• Broker-journal behavior diagnostics<br>• Rule-based Shadow Account comparisons<br>• Exportable audit reports and strategy code |
...
[Permalink: ✨ What You Can Do](https://github.com/HKUDS/Vibe-Trading#-what-you-can-do)
...
[Permalink: ⚡ Quick Example](https://github.com/HKUDS/Vibe-Trading#-quick-example)
...
[Permalink: 👥 Shadow Account](https://github.com/HKUDS/Vibe-Trading#-shadow-account-1)
...
[Permalink: 🧪 Research Workflow](https://github.com/HKUDS/Vibe-Trading#-research-workflow)
...
[Permalink: 📡 Data Sources & Smart Fallback](https://github.com/HKUDS/Vibe-Trading#-data-sources--smart-fallback)
...
- **Crypto** → `okx` · `ccxt` · `yfinance` · `local`  ·  _(futures / fund / macro / forex → `tushare`/`akshare` → `local`)_

### Using Longbridge explicitly

[Permalink: Using Longbridge explicitly](https://github.com/HKUDS/Vibe-Trading#using-longbridge-explicitly)
...
[Permalink: 💎 Optional premium data — QVeris](https://github.com/HKUDS/Vibe-Trading#-optional-premium-data--qveris)

![QVeris](https://camo.githubusercontent.com/d894db7cca02fb4c17ad8439b58e1281d2317a247a0342d098abaa0bf99cb78c/68747470733a2f2f7777772e7176657269732e636f6d2f6c6f676f2d636f6c6f722e706e67)
...
_QVeris disclosure: [signing up through the Vibe-Trading referral link](https://qveris.ai/?ref=Vyjjo5G_1cAHJA) gets you **+1,000 bonus credits** and supports the project._

* * *

## 🔩 Detailed Capabilities

[Permalink: 🔩 Detailed Capabilities](https://github.com/HKUDS/Vibe-Trading#-detailed-capabilities)
...
4. _(Optional)_ slot it into a market's `FALLBACK_CHAINS` in `registry.py` so
...
[Permalink: 🚀 Quick Start](https://github.com/HKUDS/Vibe-Trading#-quick-start)
...
[Permalink: Scheduled research](https://github.com/HKUDS/Vibe-Trading#scheduled-research)
...
[Permalink: SWARM external MCP tools](https://github.com/HKUDS/Vibe-Trading#swarm-external-mcp-tools)
...
[Permalink: 🔌 Loading Tools from External MCP Servers (MCP Client Mode)](https://github.com/HKUDS/Vibe-Trading#-loading-tools-from-external-mcp-servers-mcp-client-mode)

> **This is the opposite direction from the MCP Plugin above.**
> The MCP Plugin lets _other_ agents call Vibe-Trading tools.
> This section lets the _built-in_ Vibe-Trading agent call tools from _your_ external MCP servers.
...
[Permalink: Official IBKR MCP read-only probe](https://github.com/HKUDS/Vibe-Trading#official-ibkr-mcp-read-only-probe)
...
[Permalink: Trading connectors: fastest path](https://github.com/HKUDS/Vibe-Trading#trading-connectors-fastest-path)
...
[Permalink: 🔐 TAP Mode — full credential isolation & human-approved writes](https://github.com/HKUDS/Vibe-Trading#-tap-mode--full-credential-isolation--human-approved-writes)
...
forwards without a human step — this is credential _isolation_ (no key in the
...
[Permalink: Config reference](https://github.com/HKUDS/Vibe-Trading#config-reference)
...
[Permalink: Per-session overrides (API)](https://github.com/HKUDS/Vibe-Trading#per-session-overrides-api)
...
[Permalink: Tool naming](https://github.com/HKUDS/Vibe-Trading#tool-naming)
...
[Permalink: v1 limits](https://github.com/HKUDS/Vibe-Trading#v1-limits)
...
[vibetrading.wiki/](https://vibetrading.wiki/ "https://vibetrading.wiki/")
...
## [Releases\  8](https://github.com/HKUDS/Vibe-Trading/releases)

[v0.1.11 — India equity, fundamental factors, IM channels + roll-up\\
Latest\\
\\
2 weeks agoJul 10, 2026](https://github.com/HKUDS/Vibe-Trading/releases/tag/v0.1.11)

[\+ 7 releases](https://github.com/HKUDS/Vibe-Trading/releases)

## [Packages\  1](https://github.com/orgs/HKUDS/packages?repo_name=Vibe-Trading)

- [vibe-trading](https://github.com/orgs/HKUDS/packages/container/package/vibe-trading)

### Uh oh!

There was an error while loading. [Please reload this page](https://github.com/HKUDS/Vibe-Trading).

## [Contributors\  102](https://github.com/HKUDS/Vibe-Trading/graphs/contributors)

- [![@warren618](https://avatars.githubusercontent.com/u/127300695?s=64&v=4)](https://github.com/warren618)
- [![@xkam7ar](https://avatars.githubusercontent.com/u/193838802?s=64&v=4)](https://github.com/xkam7ar)
...
- [![@santhreal](https://avatars.githubusercontent.com/u/64453045?s=64&v=4)](https://github.com/santhreal)
- [![@Elfsa-Miranda](https://avatars.githubusercontent.com/u/230687636?s=64&v=4)](https://github.com/Elfsa-Miranda)
- [![@Teerapat-Vatpitak](https://avatars.githubusercontent.com/u/155278130?s=64&v=4)](https://github.com/Teerapat-Vatpitak)
- [![@Robin1987China](https://avatars.githubusercontent.com/u/41602358?s=64&v=4)](https://github.com/Robin1987China)
- [![@dependabot[bot]](https://avatars.githubusercontent.com/in/29110?s=64&v=4)](https://github.com/apps/dependabot)
- [![@sambazhu](https://avatars.githubusercontent.com/u/15724536?s=64&v=4)](https://github.com/sambazhu)
...
- [![@skloxo](https://avatars.githubusercontent.com/u/26531749?s=64&v=4)](https://github.com/skloxo)
- [![@MikeCer](https://avatars.githubusercontent.com/u/1618166?s=64&v=4)](https://github.com/MikeCer)

[\+ 88 contributors](https://github.com/HKUDS/Vibe-Trading/graphs/contributors)

## Languages

- [Python90.8%](https://github.com/HKUDS/Vibe-Trading/search?l=python)
- [TypeScript7.0%](https://github.com/HKUDS/Vibe-Trading/search?l=typescript)
- [HTML1.2%](https://github.com/HKUDS/Vibe-Trading/search?l=html)
- [JavaScript0.4%](https://github.com/HKUDS/Vibe-Trading/search?l=javascript)
- [CSS0.3%](https://github.com/HKUDS/Vibe-Trading/search?l=css)
- [Shell0.1%](https://github.com/HKUDS/Vibe-Trading/search?l=shell)
- Other0.2%
